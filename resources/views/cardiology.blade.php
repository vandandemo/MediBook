...
<head>
    <meta charset="utf-8" />
    <title>Cardiology Services - Medibook</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Professional cardiology and heart care services for optimal cardiovascular health.">
...
<body>
    <div class="landing-page">
        ...
        <section class="section cardiology-section pt-5 mt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="display-4 fw-bold">Cardiology & Heart Care</h1>
                            <p class="text-muted">Expert care for your heart health</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Heart Disease Treatment</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Cardiac Surgery</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Stress Testing</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Echocardiography</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Advanced ECG Machines</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Cardiac Catheterization Lab</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>3D Echocardiography</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Cardiac MRI</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Cardiologists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Cardiac Surgeons</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Interventional Cardiologists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Cardiac Nurses</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Cardiac Rehabilitation</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Heart Health Education</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Preventive Cardiology</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>24/7 Emergency Care</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4 text-center">
                                <h3 class="mb-4">Need Cardiac Care?</h3>
                                <p class="text-muted mb-4">Contact us for expert heart care services</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="map-header text-center">
                            ...
                            <p>Visit our cardiology center at the following location.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
            ...
            <div class="container">
                <div class="row justify-content-between g-2">
                    <div class="col-lg-4">
                        ...
                        <p class="mt-4 text-white-50">Expert cardiology and heart care services for optimal cardiovascular health.</p>
                    ...
                    <div class="col-lg-2">
                        <h5>Services :</h5>
                        <ul>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Heart Disease Treatment</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Cardiac Surgery</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Stress Testing</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Echocardiography</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Cardiac Rehabilitation</a></li>
