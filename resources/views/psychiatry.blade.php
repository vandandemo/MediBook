...
<head>
    <meta charset="utf-8" />
    <title>Psychiatry Services - Medibook</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Professional psychiatric services with expert mental health specialists for comprehensive mental healthcare.">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="display-4 fw-bold">Psychiatry <span class="text-primary">Services</span></h1>
                            <p>Providing comprehensive mental healthcare with our expert psychiatric team.</p>
                        </div>
                    </div>
                </div>
...
<!-- <h3 class="mb-4">Our Services</h3>-->
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="card-title mb-1">Mental Health Assessment</h4>
                                        <p class="text-muted mb-0">Comprehensive evaluation and diagnosis</p>
                                    </div>
                                </div>  
                            </div>
                        </div>
...
<!-- <h3 class="mb-4">Our Services</h3>-->
                                <div class="d-flex align-items-center mb-4">
                                    <div class="flex-shrink-0">
                                        <i class="mdi mdi-psychology text-primary" style="font-size: 2.5rem;"></i>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="card-title mb-1">Psychotherapy</h4>
                                        <p class="text-muted mb-0">Individual and group therapy sessions</p>
                                    </div>
                                </div>  
                            </div>
                        </div>
...
<!-- <h3 class="mb-4">Our Services</h3>-->
                                <div class="d-flex align-items-center mb-4">
                                    <div class="flex-shrink-0">
                                        <i class="mdi mdi-pill text-primary" style="font-size: 2.5rem;"></i>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="card-title mb-1">Medication Management</h4>
                                        <p class="text-muted mb-0">Prescription and monitoring of medications</p>
                                    </div>
                                </div>  
                            </div>
                        </div>
...
<!-- <h3 class="mb-4">Our Services</h3>-->
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="card-title mb-1">Family Counseling</h4>
                                        <p class="text-muted mb-0">Support for families and loved ones</p>
                                    </div>
                                </div>  
                            </div>
                        </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        <div class="equipment-item text-center p-3">
                                            ...
                                            <h5 class="mt-3">Digital Assessment Tools</h5>
                                            <p>Advanced mental health screening</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="equipment-item text-center p-3">
                                            <i class="mdi mdi-video display-4 text-primary"></i>
                                            <h5 class="mt-3">Telepsychiatry Systems</h5>
                                            <p>Remote consultation capabilities</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="equipment-item text-center p-3">
                                            <i class="mdi mdi-clipboard-check display-4 text-primary"></i>
                                            <h5 class="mt-3">Digital Progress Tracking</h5>
                                            <p>Patient progress monitoring systems</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row mt-5">
                    <div class="col-lg-12">
                        <div class="card shadow-sm">
                            <div class="card-body p-4">
                                <h3 class="mb-4">Our Psychiatric Team</h3>
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        <div class="specialist-item text-center p-3">
                                            <img src="build\images\landing\doctor-4.png" alt="Psychiatrist" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
                                            <h5>Dr. Sarah Wilson</h5>
                                            <p>Clinical Psychiatrist</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="specialist-item text-center p-3">
                                            <img src="build\images\landing\doctor-3.png" alt="Psychiatrist" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
                                            <h5>Dr. Michael Chen</h5>
                                            <p>Child Psychiatrist</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="specialist-item text-center p-3">
                                            <img src="build\images\landing\doctor-5.png" alt="Psychiatrist" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
                                            <h5>Dr. Emily Rodriguez</h5>
                                            <p>Addiction Specialist</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="program-item p-3 bg-light rounded">
                                            <h5><i class="mdi mdi-clock-fast me-2"></i>24/7 Crisis Support</h5>
                                            <p>Emergency mental health assistance</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="program-item p-3 bg-light rounded">
                                            <h5><i class="mdi mdi-school me-2"></i>Mental Health Education</h5>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="contact-header text-center">
                            <h1 class="lh-base">Contact Our <span class="text-primary">Psychiatric Team</span></h1>
                            <p>Get in touch with our psychiatry department for mental health support and guidance</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="map-header text-center">
                            ...
                            <p>Visit our psychiatric center at the following location</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
