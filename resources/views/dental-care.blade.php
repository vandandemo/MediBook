...
<head>
    <meta charset="utf-8" />
    <title>Dental Care Services - Medibook</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Professional dental care services for optimal oral health.">
...
<body>
    <div class="landing-page">
        ...
        <section class="section dental-section pt-5 mt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="display-4 fw-bold">Dental Care Services</h1>
                            <p class="text-muted">Expert care for your oral health</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="flex-shrink-0">
                                        <i class="mdi mdi-tooth text-primary" style="font-size: 2.5rem;"></i>
                                    </div>
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>General Dentistry</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Cosmetic Dentistry</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Orthodontics</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Oral Surgery</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Digital X-rays</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Intraoral Cameras</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Laser Dentistry</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>3D Imaging</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>General Dentists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Orthodontists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Oral Surgeons</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Dental Hygienists</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Teeth Whitening</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Dental Implants</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4 text-center">
                                <h3 class="mb-4">Need Dental Care?</h3>
                                <p class="text-muted mb-4">Contact us for expert dental services</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="map-header text-center">
                            ...
                            <p>Visit our dental care center at the following location.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
            ...
            <div class="container">
                <div class="row justify-content-between g-2">
                    <div class="col-lg-4">
                        ...
                        <p class="mt-4 text-white-50">Expert dental care services for optimal oral health.</p>
                    ...
                    <div class="col-lg-2">
                        <h5>Services :</h5>
                        <ul>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>General Dentistry</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Cosmetic Dentistry</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Orthodontics</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Oral Surgery</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Emergency Care</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Teeth Whitening</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2">
                        <h5>Quick Links :</h5>
