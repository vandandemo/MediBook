...
<head>
    <meta charset="utf-8" />
    <title>Neurology Services - Medibook</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Professional neurology and brain care services for optimal neurological health.">
...
<body>
    <div class="landing-page">
        ...
        <!-- Neurology Section Start -->
        <section class="section neurology-section pt-5 mt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="display-4 fw-bold">Neurology Services</h1>
                            <p class="text-muted">Expert care for your neurological health</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Brain Disorder Treatment</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Spinal Cord Care</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Nerve Disorder Management</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Neuromuscular Treatment</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>MRI Scanners</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>EEG Machines</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>EMG Equipment</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Nerve Conduction Studies</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Neurologists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Neurosurgeons</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Neurophysiologists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Neurology Nurses</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Stroke Care</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Epilepsy Management</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Multiple Sclerosis Care</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Neurological Rehabilitation</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4 text-center">
                                <h3 class="mb-4">Need Neurological Care?</h3>
                                <p class="text-muted mb-4">Contact us for expert neurological services</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="map-header text-center">
                            ...
                            <p>Visit our neurology center at the following location.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
            ...
            <div class="container">
                <div class="row justify-content-between g-2">
                    <div class="col-lg-4">
                        ...
                        <p class="mt-4 text-white-50">Expert neurology services for optimal brain and nervous system health.</p>
                    ...
                    <div class="col-lg-2">
                        <h5>Services :</h5>
                        <ul>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Brain Disorder Treatment</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Spinal Cord Care</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Nerve Disorder Management</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Neuromuscular Treatment</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Stroke Care</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Epilepsy Management</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2">
                        <h5>Quick Links :</h5>
