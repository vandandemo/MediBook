...
<head>
    <meta charset="utf-8" />
    <title>Orthopedic Services - Medibook</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Professional orthopedic and musculoskeletal care services for optimal bone and joint health.">
...
<body>
    <div class="landing-page">
        ...
        <!-- Orthopedic Section Start -->
        <section class="section orthopedic-section pt-5 mt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="display-4 fw-bold">Orthopedic Services</h1>
                            <p class="text-muted">Expert care for your musculoskeletal health</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Joint Replacement</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Sports Medicine</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Spine Surgery</li>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Digital X-ray Systems</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>MRI Scanners</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Arthroscopy Equipment</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Navigation Systems</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Orthopedic Surgeons</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Sports Medicine Specialists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Spine Surgeons</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Physical Therapists</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Joint Replacement Program</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Sports Injury Rehabilitation</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Spine Care Program</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Physical Therapy Services</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4 text-center">
                                <h3 class="mb-4">Need Orthopedic Care?</h3>
                                <p class="text-muted mb-4">Contact us for expert orthopedic services</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="map-header text-center">
                            ...
                            <p>Visit our orthopedic center at the following location.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
