...
<head>
    <meta charset="utf-8" />
    <title>Pulmonary Services - Medibook</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Professional pulmonary and respiratory care services for optimal lung health.">
...
<body>
    <div class="landing-page">
        ...
        <!-- Pulmonary Section Start -->
        <section class="section pulmonary-section pt-5 mt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="display-4 fw-bold">Pulmonary & Respiratory Care</h1>
                            <p class="text-muted">Expert care for your respiratory health</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="flex-shrink-0">
                                        <i class="mdi mdi-lungs text-primary" style="font-size: 2.5rem;"></i>
                                    </div>
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Asthma Management</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>COPD Treatment</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Sleep Studies</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Pulmonary Function Tests</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Advanced Spirometers</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Sleep Study Equipment</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Bronchoscopy Units</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Oxygen Therapy Systems</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Pulmonologists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Respiratory Therapists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Sleep Specialists</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Allergists</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Smoking Cessation</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Pulmonary Rehabilitation</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Asthma Education</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Sleep Disorder Management</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4 text-center">
                                <h3 class="mb-4">Need Pulmonary Care?</h3>
                                <p class="text-muted mb-4">Contact us for expert respiratory care services</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="map-header text-center">
                            ...
                            <p>Visit our pulmonary care center at the following location.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
            ...
            <div class="container">
                <div class="row justify-content-between g-2">
                    <div class="col-lg-4">
                        ...
                        <p class="mt-4 text-white-50">Expert pulmonary and respiratory care services for optimal lung health.</p>
                    ...
                    <div class="col-lg-2">
                        <h5>Services :</h5>
                        <ul>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Asthma Management</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>COPD Treatment</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Sleep Studies</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Pulmonary Tests</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Rehabilitation</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Oxygen Therapy</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2">
                        <h5>Quick Links :</h5>
