...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('receptionist.appointments.create') }}" class="btn btn-primary btn-sm">
                        ...
                        @forelse ($appointments as $appointment)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('receptionist.appointments.show', $appointment) }}" class="btn btn-info btn-sm">
        ...
        document.querySelectorAll('.delete-appointment').forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (confirm('Are you sure you want to delete this appointment?')) {
                    fetch(`/receptionist/appointments/${appointmentId}`, {
                        method: 'DELETE',
                        headers: {
