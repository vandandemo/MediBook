...
<head>
    <meta charset="utf-8" />
    <title>X-ray Services - Medibook</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Professional X-ray and diagnostic imaging services for accurate medical diagnosis.">
...
<body>
    <div class="landing-page">
        ...
        <!-- X-ray Section Start -->
        <section class="section xray-section pt-5 mt-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h1 class="display-4 fw-bold">X-ray & Diagnostic Imaging</h1>
                            <p class="text-muted">Advanced imaging technology for accurate medical diagnosis</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="flex-shrink-0">
                                        <i class="mdi mdi-radiology-box text-primary" style="font-size: 2.5rem;"></i>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="card-title mb-1">Types of X-ray</h4>
                                        <p class="text-muted mb-0">Available Services</p>
                                    </div>
                                </div>
                                <p class="card-text">We offer various types of X-ray services:</p>
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Digital X-ray</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>CT Scan</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>MRI</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Ultrasound</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Latest Digital X-ray Machines</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Advanced CT Scanners</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>High-Resolution MRI</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Modern Ultrasound Equipment</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Emergency X-ray Services</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Specialized Imaging</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Digital Reports</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Expert Interpretation</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="card-title mb-1">Safety Measures</h4>
                                        <p class="text-muted mb-0">Your Health First</p>
                                    </div>
                                </div>
                                <p class="card-text">We ensure:</p>
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Radiation Protection</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Regular Equipment Calibration</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Safety Protocols</li>
                                    <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Quality Control</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4 text-center">
                                <h3 class="mb-4">Need Diagnostic Imaging?</h3>
                                <p class="text-muted mb-4">Contact us for professional X-ray and imaging services</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="map-header text-center">
                            ...
                            <p>Visit our X-ray and diagnostic imaging center at the following location.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
            ...
            <div class="container">
                <div class="row justify-content-between g-2">
                    <div class="col-lg-4">
                        ...
                        <p class="mt-4 text-white-50">Advanced diagnostic imaging services for accurate medical diagnosis.</p>
                    ...
                    <div class="col-lg-2">
                        <h5>Services :</h5>
                        <ul>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Digital X-ray</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>CT Scan</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>MRI</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Ultrasound</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Emergency Services</a></li>
                            <li><a href="#"><i class="mdi mdi-chevron-right"></i>Digital Reports</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2">
                        <h5>Quick Links :</h5>
